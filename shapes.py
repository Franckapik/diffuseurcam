        ...
        for k in range(1, round(N * longueur_diffuseur)):
            if product_type == "0":
                vertsMortaisesInt += [
                    ...
                    *mortaiseInt(profondeur - bord_cadre - tenon_peigne, (startup + rang * k), difprops),
                ]
...
def add_cadre_tenon(difprops, productprops):
    ...
    if product_type == "2":
        vertsCadre = [
            (0, epaisseur, 0),
            *mortaiseGauche(0, largeur_accroche / 2 - tenon_cadre / 2, difprops),
            *mortaiseGauche(0, largeur_diffuseur - largeur_accroche / 2 - tenon_cadre / 2, difprops),
            (0, largeur_diffuseur - epaisseur, 0),
            *tenonHaut(
                (profondeur / 2 - tenon_cadre / 2),
                largeur_diffuseur - epaisseur,
...
def add_accroche(difprops, productprops):
    ...
    if product_type == "0":
        ...
        vertsAccroche = trou_accroche(division * 4, division * 4, division)
        vertsAccroche2 = trou_accroche(longueurTotale - division * 9, division * 4, division)
